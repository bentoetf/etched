...
export default function Docs() {
  return (
    <div className="page">
      ...
      <main className="main-col docs-col">
        <div className="slab docs-slab">
          <h2 className="docs-h">What is Etched</h2>
          <p>
            ...
            pinning service. The raw bytes of your jpeg live on chain, replicated
            by every Solana validator, for as long as Solana exists.
          </p>
        </div>
        <div className="slab docs-slab">
          ...
          <ol className="docs-list">
            ...
            <li>
              ...
              initialized and allocated, and your image is written on chain in
              850-byte chunks. You sign once, then the chunks stream with a
              progress bar.
            </li>
        ...
        <div className="slab docs-slab">
          ...
          <p>
            Pricing is dynamic. You pay the actual Solana rent for the account
            that stores your bytes (bigger image, more rent), plus a flat
            service fee tier:
          </p>
          ...
          <p>
            The exact total is shown before you sign anything. No hidden costs.
          </p>
        </div>
        <div className="slab docs-slab">
          <h2 className="docs-h">Permanence</h2>
          <p>
            Rent-exempt Solana accounts persist indefinitely. Once written, your
            inscription cannot be taken down by us or anyone else. The Wall
            reads inscriptions straight from the chain, so even if this site
            vanished, your bytes would not.
          </p>
        </div>
        <div className="slab docs-slab">
          <h2 className="docs-h">FAQ</h2>
          ...
          <p>
            You do. The NFT mint lands in your wallet, the inscription account
            is tied to it.
          </p>
          <p className="docs-q">What happens if the transaction fails midway?</p>
          <p>
